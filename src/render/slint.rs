...
const ARROW_U_SVG: &str = r##"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#ffffff" d="M4 15h6v5h4v-5h6L12 4 4 15z"/></svg>"##;
const ARROW_D_SVG: &str = r##"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#ffffff" d="M20 9l-8 8-8-8z"/></svg>"##;
